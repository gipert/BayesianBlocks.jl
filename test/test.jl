...
edges = BayesianBlocks.bayesian_blocks(data, logfitness=:cash, logprior=:p0, p0=0.01)
@test edges ≈ [-3.48528, -1.87114, -1.36282, -0.677218,
              0.659105, 1.39771, 4.06582, 5.60912,
              6.17286, 7.76634, 9.91696 ] atol = 1E-04

edges = BayesianBlocks.bayesian_blocks(data, logfitness=:cash, logprior=:gamma, gamma=0.01)
...
edges = BayesianBlocks.bayesian_blocks(fit(Histogram, data, nbins=100, closed = :left),
